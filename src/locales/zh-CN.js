...
export default {
  ...
  'form.action': '操作',
  'form.search': '查询',
  'form.search.advanced': '高级查询',
  'form.reset': '重置',
  'form.reset.clear': '清除重置',
  'form.add': '添加',
  'form.edit': '编辑',
  'form.delete': '删除',
  'form.more': '更多',
  ...
  'form.biz.add': '添加成功',
  'form.biz.edit': '修改成功',
  'form.biz.delete': '删除成功',
  'form.biz.delete.confirm': '确认要删除吗？',
  'form.biz.login.username': '请输入用户名',
  'form.biz.login.password': '请输入密码',
  'component.globalHeader.search': '站内搜索',
  'component.globalHeader.search.example1': '搜索提示一',
  'component.globalHeader.search.example2': '搜索提示二',
  'component.globalHeader.search.example3': '搜索提示三',
  'component.globalHeader.help': '使用文档',
  'component.globalHeader.api.doc': '接口文档',
  ...
  'menu.exception': '异常页',
  'menu.exception.not-permission': 'HTTP403',
  ...
  // =========================================================================
  'biz.dashboard.hello.prefix': '你好，',
  'biz.dashboard.hello.suffix': '祝你开心每一天！',
  'biz.dashboard.project.coding': '进行中的项目',
  'biz.dashboard.project.all': '全部项目',
  'biz.dashboard.guide': '快速开始 / 便捷导航',
  'biz.dashboard.dynamic': '动态',
  'biz.common.require.sel': '必选项！',
  'biz.common.require.input': '必填项！',
  'biz.common.length': '请输入 {length} 个字符！',
  'biz.common.length.min': '至少 {length} 个字符！',
