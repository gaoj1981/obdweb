...
export default {
  ...
  'form.action': 'Action',
  'form.search': 'Search',
  'form.search.advanced': 'Advanced',
  'form.reset': 'Reset',
  'form.reset.clear': 'ClearReset',
  'form.add': 'Add',
  'form.edit': 'Edit',
  'form.delete': 'Delete',
  'form.more': 'More',
  ...
  'component.globalHeader.api.doc': 'Interface document',
  ...
  'menu.car': 'Car Manage',
  'menu.car.basic': 'Car BaseInfo',
  'menu.car.obd': 'Car OBD',
  'menu.car.buser': 'Car User',
  'menu.car.mot': 'Car Inspection',
  'menu.car.insur': 'Car Insurance',
  'menu.equip': 'Equip Manage',
  'menu.equip.listview': 'Equip List',
